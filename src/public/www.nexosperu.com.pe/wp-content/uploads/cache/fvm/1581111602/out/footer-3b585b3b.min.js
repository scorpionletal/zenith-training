...
try{
jQuery(function($){'use strict';jQuery('.share-options a').click(function(e){'use strict';e.preventDefault()});function twitterSharer(){'use strict';window.open('https://twitter.com/intent/tweet?text='+jQuery(".title-content h2").text()+' '+window.location,"twitterWindow","width=650,height=350");return!1}
...
function pinterestSharer(){'use strict';window.open('https://pinterest.com/pin/create/bookmarklet/?media='+jQuery('.begin-content img').first().attr('src')+'&description='+jQuery('.title-content h2').text()+' '+encodeURIComponent(location.href),'pinterestWindow','width=750,height=430, resizable=1');return!1}
...
function deliciousSharer(){'use strict';window.open('https://delicious.com/save?url='+encodeURIComponent(location.href)+'?title='+jQuery(".title-content h2").text(),'deliciousWindow','width=550,height=550, resizable=1');return!1}
function linkedinSharer(){'use strict';window.open('https://www.linkedin.com/shareArticle?mini=true&url='+encodeURIComponent(location.href)+'&title='+jQuery("h1").text(),'linkedinWindow','width=650,height=450, resizable=1');return!1}});
...
try{
(function($){'use strict';$.fn.appear=function(fn,options){var settings=$.extend({data:undefined,one:!0,accX:0,accY:0},options);return this.each(function(){var t=$(this);t.appeared=!1;if(!fn){t.trigger('appear',settings.data);return}
...
try{
jQuery(function($){'use strict';jQuery(window).on('load',function(){"use strict";jQuery('.loader').fadeOut(800)});new WOW().init();jQuery("#wpadminbar").addClass("adminbar");$('.scroll').click(function(e){var link=$(this).attr("href");if(link.lastIndexOf('#')===0){$('html, body').animate({scrollTop:$(link).offset().top},700);return 0}
return!0});$(window).on('scroll',function(){if($(this).scrollTop()>20){$('.navbar-brand> img').attr('src',riwa_params.url_logo_sticky)}else{$('.navbar-brand> img').attr('src',riwa_params.url_logo)}});var tabs="#responsiveTabsDemo";var responsiveTabs={callTabs:function(){$(tabs).responsiveTabs({animation:'slide'},{'activate':'0'})}};responsiveTabs.callTabs();$(".icon-chevron-thin-down").hide();$(".btn-slide").on('click',function(){$(this).toggleClass('active')
$(this).find(".icon-chevron-thin-up, .icon-chevron-thin-down").toggle();$(".form-container").slideToggle({direction:"up"},300);e.preventdefault()});$(".counters-item").appear(function(){$(".counters-item [data-to]").each(function(){var e=$(this).attr("data-to");$(this).delay(6e3).countTo({from:50,to:e,speed:3e3,refreshInterval:50})})});$(".zerogrid").mixItUp();var $menuLeft=$(".pushmenu-left");var $menuRight=$(".pushmenu-right");var $toggleleft=$("#menu_bars.left");var $toggleright=$("#menu_bars.right");if($("#menu_bars").length){$("body").addClass("pushmenu-push");$toggleleft.on("click",function(){$(this).toggleClass("active");$(".pushmenu-push").toggleClass("pushmenu-push-toright");$menuLeft.toggleClass("pushmenu-open");return!1});$toggleright.on("click",function(){$(this).toggleClass("active");$(".pushmenu-push").toggleClass("pushmenu-push-toleft");$menuRight.toggleClass("pushmenu-open");return!1})}
$(function(){$('#dl-menu').dlmenu({animationClasses:{classin:'dl-animate-in-2',classout:'dl-animate-out-2'}})});$('.nav-icon').on('click',function(){return $(this).toggleClass('open')}.call(this));$(".navbar-default .navbar-nav li.dropdown").on('click',function(){e.preventdefault();if($(window).width()<979){$(this).next('.dropdown-menu').show();$(this).next.toggleClass('open')}});$(".navbar-default .navbar-nav li.dropdown").hover(function(){e.preventdefault();if($(window).width()>=979){$(this).find('.dropdown-menu').first().stop(!0,!0).slideToggle(500);$(this).toggleClass('open')}},function(){e.preventdefault();if($(window).width()>=979){$(this).find('.dropdown-menu').first().stop(!0,!0).slideUp();$(this).removeClass('open')}});if($('#back-top').length){var scrollTrigger=600,backToTop=function(){var scrollTop=$(window).scrollTop();if(scrollTop>scrollTrigger){$('#back-top').addClass('show')}else{$('#back-top').removeClass('show')}};backToTop();$(window).on('scroll',function(){backToTop()});$('#back-top').on('click',function(e){e.preventDefault();$('html,body').animate({scrollTop:0},700,'linear')})}
$("#service-slider , #specialist-slider").owlCarousel({autoPlay:!1,items:2,pagination:!1,navigationText:["<i class='fa fa-angle-left'></i>","<i class='fa fa-angle-right'></i>"],navigation:!0,itemsDesktop:[1199,2],itemsDesktopSmall:[979,2],itemsTablet:[768,2],itemsMobile:[480,1],});$("#blog-slider").owlCarousel({autoPlay:!1,singleItem:!0,pagination:!1,navigationText:["<i class='fa fa-angle-left'></i>","<i class='fa fa-angle-right'></i>"],navigation:!0,itemsDesktop:[1199,2],itemsDesktopSmall:[979,2],itemsMobile:[480,1],});$("#our-specialist , #team-slider , #food-slider").owlCarousel({autoPlay:4000,items:2,pagination:!1,navigationText:["<i class='fa fa-angle-left'></i>","<i class='fa fa-angle-right'></i>"],navigation:!0,itemsDesktop:[1199,2],itemsDesktopSmall:[979,2],itemsMobile:[480,1]});var clientSlider={sliderCall:function(){$("#client-slider").owlCarousel({navigation:!0,slideSpeed:300,paginationSpeed:400,singleItem:!0,navigationText:['<i class="fa fa-angle-left" aria-hidden="true"></i>','<i class="fa fa-angle-right" aria-hidden="true"></i>'],stopOnHover:!0,pagination:!1})}};clientSlider.sliderCall();$(".items > li > a").on('click',function(e){e.preventDefault();var $this=$(this);if($this.hasClass("expanded")){$this.removeClass("expanded")}else{$(".items a.expanded").removeClass("expanded");$this.addClass("expanded");$(".sub-items").filter(":visible").slideUp("normal")}
$this.parent().children("ul").stop(!0,!0).slideToggle("normal");e.preventdefault()});$(".tab_content").hide();$(".tab_content:first").show();$("ul.tabs li").on('click',function(){$(".tab_content").hide();var activeTab=$(this).attr("rel");$("#"+activeTab).fadeIn();$("ul.tabs li").removeClass("active");$(this).addClass("active");$(".tab_drawer_heading").removeClass("d_active");$(".tab_drawer_heading[rel^='"+activeTab+"']").addClass("d_active")});$(".tab_drawer_heading").on('click',function(){$(".tab_content").hide();var d_activeTab=$(this).attr("rel");$("#"+d_activeTab).fadeIn(1200);$(".tab_drawer_heading").removeClass("d_active");$(this).addClass("d_active");$("ul.tabs li").removeClass("active");$("ul.tabs li[rel^='"+d_activeTab+"']").addClass("active")});$(".fancybox").fancybox({openEffect:'elastic',openSpeed:650,closeEffect:'elastic',closeSpeed:550,closeClick:!0,helpers:{overlay:{locked:!1}}});$(".video").fancybox({fitToView:!0,autoSize:!0,closeClick:!1,helpers:{overlay:{locked:!1}}});$('#datetimepicker').datetimepicker({format:"dd MM yyyy"})});
